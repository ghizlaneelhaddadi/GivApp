...
import com.example.test1000.databinding.ActivityAdminArametreBinding
import com.example.test1000.databinding.ActivityParametreBinding
import com.google.firebase.auth.FirebaseAuth

class AdminParametreActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private lateinit var binding: ActivityAdminArametreBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdminArametreBinding.inflate(layoutInflater)
